...
public class BeymenStepDefinitions {
    ...
    public void user_writes_the_selected_product_s_information_and_prize_to_txt_file() {
        ...
        productCost=productPage.productPrice.getText();
    ...
    public void user_verifies_that_the_price_of_the_product_on_the_product_pace_matches_with_the_product_price_in_the_basket() {
        ...
        String basketPrize = productPage.basketPrice.getText().trim().substring(0,productPage.basketPrice.getText().trim().indexOf(","));
        System.out.println(productPrice+" "+basketPrize);
        Assert.assertEquals(productPrice,basketPrize);
